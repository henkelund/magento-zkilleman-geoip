...
class Zkilleman_GeoIP_Model_Indexer_Country extends Mage_Index_Model_Indexer_Abstract
{
    ...
    protected function _construct()
    {
        ...
        if ($source = $config->getCountrySource()) {
    ...
    {
        return Mage::helper('geoip')->__('GeoIP Countries');
    }
    ...
    {
        return Mage::helper('geoip')->__('IP range to country index');
    }
