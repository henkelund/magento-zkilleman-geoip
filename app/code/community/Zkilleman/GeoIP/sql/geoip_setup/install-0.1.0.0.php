...
$table = $installer->getConnection()
    ->newTable($installer->getTable('geoip/country'))
    ...
    ->addColumn('start_ip', Varien_Db_Ddl_Table::TYPE_TEXT, 15, array(
        'nullable'  => false
        ), 'Start IP')
    ->addColumn('end_ip', Varien_Db_Ddl_Table::TYPE_TEXT, 15, array(
        'nullable'  => false
        ), 'End IP')
    ->addColumn('start_ip_int', Varien_Db_Ddl_Table::TYPE_INTEGER, null, array(
        'unsigned'  => true
        ), 'Start IP Integer')
    ->addColumn('end_ip_int', Varien_Db_Ddl_Table::TYPE_INTEGER, null, array(
        'unsigned'  => true
        ), 'End IP Integer')
    ...
    ->addIndex($installer->getIdxName(
            ...
            array('country_code'))
    ->setComment('GeoIP Country Table');
 ...
 */
$table = $installer->getConnection()
    ->newTable($installer->getTable('geoip/country_tmp'))
    ->addColumn('range_id', Varien_Db_Ddl_Table::TYPE_INTEGER, null, array(
        'identity'  => true,
        'unsigned'  => true,
        'nullable'  => false,
    ...
    ->setComment('GeoIP Country Tmp Table');
$installer->getConnection()->createTable($table);
